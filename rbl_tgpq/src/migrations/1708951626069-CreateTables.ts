    ...
    await queryRunner.query(
      `INSERT INTO \`person_model\` (\`id\`, \`name\`, \`health_max\`, \`strength\`, \`dexterity\`, \`dodge\`, \`description\`, \`url_image\`, \`difficulty\`, \`category\`, \`created_at\`, \`updated_at\`)
        VALUES 
          ...
          ('2b2f28e1-c443-4a78-bb23-456c78901234', 'Goblin', 111, 30, 35, 10, 'A mischievous goblin causing trouble.', 'monsters/tgpq_monster_goblin.png', 1, 'GOLEM', DEFAULT, DEFAULT),
          ('2b2f28e1-c443-4a78-bb23-456c78901269', 'Gobltwo', 111, 30, 40, 40, 'A second mischievous goblin causing trouble.', 'monsters/tgpq_monster_gobltwo.png', 1, 'GOLEM', DEFAULT, DEFAULT),
          ('2b2f28e1-c443-4a78-bb23-456c78901288', 'Goblthird', 111, 30, 50, 60, 'A third mischievous goblin causing trouble.', 'monsters/tgpq_monster_goblthird.png', 1, 'GOLEM', DEFAULT, DEFAULT),
          ...
          ('3c3d39f8-76a5-4d72-aaf7-987654321def', 'Hero', 100, 35, 50, 25, 'Your hero which is going to defeat everything.', 'heroes/tgpq_character_peasant.png', 10, 'HERO', DEFAULT, DEFAULT);`,
    );
    await queryRunner.query(
